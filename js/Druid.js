DocsTr = {
    ...
    map: [
        ...
        [
            ...
            ["tutorials/tutorial-batch", "教程: 加载文件"],
            ["tutorials/tutorial-kafka", "教程: 从Kafka加载流式数据"],
            ["tutorials/tutorial-batch-hadoop", "教程: 使用Hadoop加载批量数据"],
            ["tutorials/tutorial-tranquility", "教程: Http推送流式数据"],
            ["tutorials/tutorial-query", "查询数据"]
        ], 
        [
            ["ingestion", "简介"]
        ]
